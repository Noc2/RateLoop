...
export const vote = onchainTable(
  ...
  (t) => ({
    ...
    correlationVerifiedHuman: t.boolean(),
    correlationHistoricalVoteCount: t.integer(),
    correlationCredentialProvider: t.integer(),
    correlationCredentialNullifierHash: t.hex(),
    correlationCredentialVerifiedAt: t.bigint(),
    correlationCredentialExpiresAt: t.bigint(),
    correlationBanReasons: t.text(),
  }),
  (table) => ({
...
export const launchEarnedRaterCredit = onchainTable(
  ...
  (t) => ({
    ...
    sourceBlockNumber: t.bigint(),
    sourceTxHash: t.hex(),
    sourceLogIndex: t.integer(),
    sourceTimestamp: t.bigint(),
    correlationVerifiedHuman: t.boolean(),
    correlationHistoricalVoteCount: t.integer(),
    correlationCredentialProvider: t.integer(),
    correlationCredentialNullifierHash: t.hex(),
