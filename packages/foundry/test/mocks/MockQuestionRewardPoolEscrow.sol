...
contract MockQuestionRewardPoolEscrow {
    /// @dev I-Identity-A: ContentRegistry.setQuestionRewardPoolEscrow now probes this
    ///      autogenerated getter to confirm ABI shape before pointing the registry at the escrow.
