...
library TlockVoteLib {
    ...
    function _validateTargetRound(
        ...
        // Preserve two drand periods of scheduling tolerance without letting
        // voters extend a custom blind epoch by another full epoch.
        epochDuration;
        uint64 maxTargetRound = _roundAt(revealableAfter + 2 * uint256(period), genesisTime, period);
