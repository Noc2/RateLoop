...
SUBMISSION_BOUNTY_START_BY="0"
SUBMISSION_BOUNTY_WINDOW_SECONDS="0"
SUBMISSION_BOUNTY_FEEDBACK_WINDOW_SECONDS="0"
...
BUNDLE_BOUNTY_START_BY=$((CURRENT_BLOCK_TIMESTAMP + SUBMISSION_BUNDLE_BOUNTY_DEADLINE_SECONDS))
BUNDLE_BOUNTY_WINDOW_SECONDS="$SUBMISSION_BUNDLE_BOUNTY_DEADLINE_SECONDS"
BUNDLE_FEEDBACK_WINDOW_SECONDS="$SUBMISSION_BUNDLE_BOUNTY_DEADLINE_SECONDS"
...
BUNDLE_BUILD_OUTPUT=$(node "$SCRIPT_DIR/../scripts-js/buildQuestionBundleReservation.js" \
  ...
  "$BUNDLE_BOUNTY_START_BY" "$BUNDLE_BOUNTY_WINDOW_SECONDS" "$BUNDLE_FEEDBACK_WINDOW_SECONDS" \
