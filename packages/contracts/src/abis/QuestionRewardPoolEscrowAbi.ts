export const QuestionRewardPoolEscrowAbi = [
  ...
  {
    "type": "function",
    "name": "refundExpiredRecoveredRewardPool",
    "inputs": [
      {
        "name": "rewardPoolId",
        "type": "uint256",
  ...
  {
    "type": "function",
    "name": "refundInactiveRecoveredRewardPool",
    "inputs": [
      {
        "name": "rewardPoolId",
        "type": "uint256",
  ...
  {
    "type": "function",
    "name": "refundPreQualificationRejectedRewardPool",
    "inputs": [
      {
        "name": "rewardPoolId",
        "type": "uint256",
  ...
  {
    "type": "function",
    "name": "refundRecoveredQuestionBundleReward",
    "inputs": [
      {
        "name": "bundleId",
        "type": "uint256",
  ...
  {
    "type": "event",
    "name": "PreQualificationRejectedSnapshotRoundAbandoned",
    "inputs": [
      {
        "name": "rewardPoolId",
        "type": "uint256",
  ...
  {
    "type": "event",
    "name": "RecoveredSnapshotBundleRoundSetAbandoned",
    "inputs": [
      {
        "name": "bundleId",
        "type": "uint256",
  ...
  {
    "type": "event",
    "name": "RecoveredSnapshotRoundAbandoned",
    "inputs": [
      {
        "name": "rewardPoolId",
        "type": "uint256",
  ...
  {
    "type": "error",
    "name": "PreQualificationRejectedRoundPending",
    "inputs": []
  },
  {
    "type": "error",
