export const FeedbackRegistryAbi = [
  ...
  {
    "type": "function",
    "name": "CONTENT_FEEDBACK_HASH_DOMAIN",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "function",
    "name": "awardableFeedbackPublishedAt",
    "inputs": [
      {
        "name": "contentId",
        "type": "uint256",
