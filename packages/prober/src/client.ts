...
export function getAccount() {
  ...
  throw new Error("No wallet configured. Set KEYSTORE_ACCOUNT+KEYSTORE_PASSWORD or PROBER_PRIVATE_KEY");
}
...
type ProberConnectivityClient = Pick<typeof publicClient, "getChainId">;

export async function validateProberConnectivity(client: ProberConnectivityClient = publicClient) {
