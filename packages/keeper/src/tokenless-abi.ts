...
export const TokenlessPanelAbi = parseAbi([
  ...
  "function finalizeScoringSeed(uint256 roundId,bytes32 randomness,bytes proof)",
  "function finalizeScoringFallback(uint256 roundId)",
...
export const TokenlessFeedbackBonusAbi = parseAbi([
  ...
  "function withdrawableCredit(address recipient) view returns (uint256 amount)",
  "function withdrawCredit(address destination) returns (uint256 amount)",
]);
