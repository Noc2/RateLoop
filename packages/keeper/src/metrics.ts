...
function renderMetrics(): string {
  ...
  const counterHelp: Record<string, string> = {
    ...
    keeper_feedback_reveal_jobs_leased_total: "Total feedback reveal jobs leased from the app queue",
    keeper_feedback_reveals_total: "Total content feedback reveals submitted by keeper",
    keeper_feedback_reveal_failures_total: "Total content feedback reveal jobs reported failed by keeper",
    keeper_feedback_reveal_already_revealed_total: "Total content feedback jobs already revealed on-chain",
