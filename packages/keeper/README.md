...
| `KEEPER_WORK_DISCOVERY_CHAIN_SCAN_PER_TICK`       | `ceil(maxCandidates / reconcileEveryTicks)` (default `5`)           | On Ponder ticks, also process the next N content IDs from a rotating chain cursor                                  |
