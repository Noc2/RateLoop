...
| `CRON_SECRET`                                          | Vercel Cron bearer secret accepted by attachment cleanup, confidentiality disclosure reconciliation, log-root publication, and callback sweep jobs                                           |
