...
- Bounties can stay open to everyone or require Selfie Check, Passport, or Proof of Human credentials. A scoped bounty can additionally require a fresh `attestHumanPresenceWithV4Proof` recheck shortly before the vote commit.
