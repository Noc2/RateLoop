...
| `NEXT_PUBLIC_TARGET_NETWORKS`                          | Comma-separated deployed chain IDs exposed in the UI; use Base Sepolia (`84532`) for the first Base test deployment and Base mainnet (`8453`) after promotion                                |
