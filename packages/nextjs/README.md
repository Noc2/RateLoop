...
| `WORLD_ID_V4_RP_ID`                               | Legacy fallback for Next.js only when it contains an `rp_...` ID; Foundry deploys use this name for the numeric on-chain verifier RP ID, so prefer `WORLD_ID_RP_ID` in app runtime          |
