...
- The target-network parser accepts local Foundry plus the active Base deployment targets: `31337`, `84532`, and `8453`. Live builds fail fast if the selected chain does not have generated deployment metadata in `@rateloop/contracts`.
