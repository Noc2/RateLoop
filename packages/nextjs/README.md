...
- Bounties can stay open to everyone or require Passport or Proof of Human credentials. Selfie Check is v4-gated by `NEXT_PUBLIC_WORLD_ID_ENABLE_V4_SELFIE`; any scoped bounty can additionally require a fresh `attestHumanPresenceWithV4Proof` recheck shortly before the vote commit.
