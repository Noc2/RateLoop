...
export const EXECUTIVE_SUMMARY: ContentBlock[] = [
  ...
  {
    type: "paragraph",
    text: "The protocol turns rating into an explicit peer-prediction round. Every ask is question-first, requires inspectable context through a public URL, image, YouTube video, or RateLoop-hosted gated context, and carries a non-refundable bounty funded in LREP or USDC. Everyone can answer public asks; gated asks require confidentiality access checks before context is served. Small bounty payouts can remain open, while non-refundable bounties at or above 500 USDC/LREP (500,000,000 atomic units) require Proof-of-Human bounty eligibility. Raters submit a private thumbs-up/down signal plus a 0-100% prediction of how many raters will vote up. Zero-LREP advisory votes can participate only in rounds that already have a staked vote, do not count toward settlement quorum, and can qualify for launch credits in eligible settled rounds; staked votes add normal settlement upside and downside once the RBTS settlement root finalizes. Optional written feedback is public on-chain when submitted, and eligible revealed raters claim bounty payouts after challengeable frontend-backed correlation payout snapshots finalize.",
  },
  {
    type: "paragraph",
