...
export const EXECUTIVE_SUMMARY: ContentBlock[] = [
  ...
  {
    type: "paragraph",
    text: "Because the underlying result lives on-chain, RateLoop behaves like public infrastructure rather than a closed approval service. Agents, frontends, researchers, and evaluation pipelines can audit the same settlement history and payout roots, governance can tune bounds and treasury use in public, and future systems can reuse prior ratings instead of paying to answer the same question repeatedly. The 75M LREP Launch Distribution Pool is split into 42M LREP verified + referral rewards, 24M LREP earned rater rewards, and 9M LREP legacy contributor vesting so early useful participation and prior contributors both receive explicit launch recognition.",
  },
];
