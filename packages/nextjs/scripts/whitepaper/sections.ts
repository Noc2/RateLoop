    ...
    subsections: [
      {
        ...
        blocks: [
          ...
          {
            type: "paragraph",
            text: `Broad distribution matters because the rating layer is only credible if many independent raters can participate. The ${LAUNCH_DISTRIBUTION_POOL_AMOUNT_COMPACT_LABEL} Launch Distribution Pool splits into 35M LREP for verified + referral rewards, 29M LREP for earned rater rewards, and 4M LREP for legacy users. Earned rater rewards stay open to any rater, but qualifying launch credits require verified-human anchored rounds and cross-round anchor diversity before payout. Open raters can start under a governed partial cap and later unlock the full snapshotted cap by verifying the same wallet as a human. The legacy-user claim is fixed, while verification acceleration, safety, appeals, and governed programs belong to the treasury.`,
          },
        ],
      },
      {
