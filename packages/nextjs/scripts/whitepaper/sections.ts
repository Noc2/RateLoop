        ...
        blocks: [
          {
            ...
            items: [
              ...
              "Payment modes include ordered `wallet_calls` for LREP or USDC escrow funding and `eip3009_usdc_authorization` for World Chain USDC asks; `x402_authorization` remains a compatibility alias.",
