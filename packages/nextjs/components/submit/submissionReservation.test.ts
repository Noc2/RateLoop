...
const EXTRA_UPLOADED_IMAGE_URL =
  "https://www.rateloop.ai/api/attachments/images/att_extraabcdefghijkl.webp#sha256=0xbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb";
const DEFAULT_DRAFT = {
  categoryId: 1n,
