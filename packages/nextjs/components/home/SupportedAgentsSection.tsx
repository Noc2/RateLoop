...
const RATELOOP_AGENT_PROMPT =
  "Read RateLoop's agent docs: https://www.rateloop.ai/docs/ai and https://www.rateloop.ai/docs/how-it-works. Explain how you can use RateLoop for me: turn a public URL, YouTube video, user-provided image, or agent-generated context/image into paid open-rater ratings and written feedback you can cite. Cover the default flow: create or collect public context, include generated/local image bytes as generatedImages when useful, choose a template only if needed, quote, call rateloop_create_ask_handoff_link, share the returned handoffUrl for browser wallet funding/signing, poll handoff/status, then fetch results via MCP/API: https://www.rateloop.ai/api/mcp/public. Do not ask me to paste raw wallet signatures unless I explicitly request the low-level MCP path. Give one workflow to try with you, including an option where you generate the context first.";
