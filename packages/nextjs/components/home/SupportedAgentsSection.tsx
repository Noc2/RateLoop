...
const RATELOOP_AGENT_PROMPT =
  "Read RateLoop's agent docs: https://www.rateloop.ai/docs/ai and https://www.rateloop.ai/docs/how-it-works. Explain how you can use RateLoop for me: turn a public URL, YouTube video, user-provided image, or agent-generated context/image uploaded to RateLoop into paid open-rater ratings and written feedback you can cite. Cover the flow: create or collect public context, upload generated/local image bytes when useful, choose a template, quote, fund a World Chain USDC bounty, get reputation-qualified commit-reveal ratings/feedback, then fetch results via MCP/API: https://www.rateloop.ai/api/mcp/public. Give one workflow to try with you, including an option where you generate the context first.";

const LOVABLE_AGENT_PROMPT =
  "Build a concise interactive page showing how someone can use RateLoop with the AI agent they already use. Use https://www.rateloop.ai/docs/ai and https://www.rateloop.ai/docs/how-it-works as source links. Explain the benefit: paid open-rater ratings and written feedback from public URLs, YouTube videos, user-provided images, or agent-generated context/images uploaded to RateLoop, funded with World Chain USDC and fetched through MCP/API at https://www.rateloop.ai/api/mcp/public.";
