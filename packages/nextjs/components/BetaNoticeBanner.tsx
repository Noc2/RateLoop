...
import { PROTOCOL_BETA_GOVERNANCE_HREF, PROTOCOL_BETA_LABEL, PROTOCOL_IS_BETA } from "~~/constants/protocolRelease";
    ...
    <div className="border-b border-white/10 bg-black px-4 py-2.5 text-base-content shadow-[0_12px_32px_rgba(0,0,0,0.22)] sm:px-6">
      <div className="mx-auto flex max-w-6xl items-start gap-3 xl:max-w-none">
        ...
        <p className="min-w-0 flex-1 text-sm font-medium leading-5 text-base-content">
          RateLoop is in {PROTOCOL_BETA_LABEL}. The Base mainnet contract stack is live production infrastructure while
          off-chain services and governance parameters continue to mature.{" "}
          <Link
