...
export function AccountDeletionPanel() {
  ...
  function handleToggle(event: SyntheticEvent<HTMLDetailsElement>) {
    if (event.currentTarget.open && !preview && !loading) void loadPreview();
  }
  ...
  return (
    <details className="surface-card rounded-2xl p-6" onToggle={handleToggle}>
      <summary className="cursor-pointer text-sm font-semibold text-error">Delete account</summary>
      <div className="mt-5 border-t border-white/10 pt-5">
        <h2 className="text-lg font-semibold">Delete your RateLoop account</h2>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-base-content/60">
          Eligible private data is erased. Public blockchain entries and records required for legal, tax, settlement, or
          security purposes may be retained only as required.
        </p>
