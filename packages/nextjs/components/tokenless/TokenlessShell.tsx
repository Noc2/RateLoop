...
export function TokenlessShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-base-100 text-base-content">
      ...
      <header className="sticky top-0 z-30 border-b border-base-content/10 bg-base-200 px-4 py-3 backdrop-blur-xl xl:hidden">
      ...
      <main
        id="main-content"
        tabIndex={-1}
        className="relative flex min-h-0 flex-1 flex-col overflow-x-hidden xl:pl-52"
      >
        {children}
      </main>
      <Suspense fallback={null}>
