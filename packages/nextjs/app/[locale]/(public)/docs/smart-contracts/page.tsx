...
export function generateMetadata({ params }: { params: PublicLocaleParams }): Promise<Metadata> {
  return getLocalizedPublicMetadata({ params, section: "docs", title: "Smart contracts" });
}
...
export default function TokenlessContractsPage({ params }: { params?: PublicLocaleParams } = {}) {
  ...
  return (
    <LocalizedPublicContent locale={locale} section="docs">
      <article className="prose max-w-none">
        ...
        <p>
          Return to <Link href="/docs/tech-stack#immutable-fund-core">Immutable Fund Core</Link> for the settlement
          model or the <Link href="/docs/sdk">SDK reference</Link> for the gated API sequence.
        </p>
      </article>
    </LocalizedPublicContent>
  );
