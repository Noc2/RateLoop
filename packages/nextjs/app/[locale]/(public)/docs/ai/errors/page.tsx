...
const AIErrorsPage = ({ params }: { params?: PublicLocaleParams } = {}) => {
  ...
  "retryable": true
        ...
        <h2>Polling rule</h2>
        <p>
          Keep the <code>operationKey</code> returned by <code>POST /api/agent/v1/asks</code>. Poll its wait URL and
          fetch the result only when wait returns <code>ready</code>. Do not create another ask just because settlement
          is still pending.
        </p>
      </article>
    </LocalizedPublicContent>
