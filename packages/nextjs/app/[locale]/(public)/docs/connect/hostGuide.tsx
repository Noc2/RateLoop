...
const TIER_BADGE_CLASSES: Record<TokenlessHostSupportTier, string> = {
  "release-tested": "bg-success/10 text-success",
  supported: "bg-base-content/[0.08] text-base-content/80",
  experimental: "bg-base-content/[0.04] text-base-content/60",
  unsupported: "bg-base-content/[0.04] text-base-content/45",
};

export function HostTierBadge({ locale = "en", tier }: { locale?: Locale; tier: TokenlessHostSupportTier }) {
  return (
