...
export default function TokenlessTechStackPage() {
  return (
    <article className="prose max-w-none">
      ...
      <p>
        Every ask freezes one content-hashed audience policy for its selected reviewer source. The policy binds reviewer
        source, eligibility, panel size, economics, and publication rules so the audience cannot change midway through a
        round. The schema reserves separate hybrid subpanels, but that lane is unavailable until both children have
        durable release, terminal, expiry, and refund processing.
      </p>
