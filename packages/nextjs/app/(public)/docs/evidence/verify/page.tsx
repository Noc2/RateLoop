...
export const metadata: Metadata = {
  ...
  description: "Check a RateLoop evidence packet in your browser without uploading it.",
};
...
export default function VerifyEvidencePage() {
  return (
    <article className="max-w-none">
      ...
      <p className="mt-5 max-w-3xl rounded-2xl border-l-2 border-[var(--rateloop-yellow)] bg-amber-300/[0.06] p-4 text-sm leading-6 text-base-content/70">
        Chain evidence is carried in the packet but is not independently checked here. Compare those references with an
        independently selected RPC or indexer.
      </p>
