    ...
    <main className="min-h-screen bg-base-100 px-4 py-10 text-base-content sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-start">
          <header className="border-l-2 border-[#03CEA4] pl-5">
            ...
            <p className="mt-3 max-w-2xl text-base leading-7 text-base-content/68">
              This user-provided {kind.toLowerCase()} file was uploaded as public voting context and passed automated
              text moderation before publication.
            </p>
          </header>
        ...
        <section className="mt-8 rounded-lg border border-base-content/10 bg-base-200/45 p-4 sm:p-6 lg:p-8">
          <ContextDocumentContent mimeType={document.mimeType} text={document.normalizedText} />
        </section>
      </div>
    </main>
  );
