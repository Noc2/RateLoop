export const RECOMMENDED_IMAGE_ASPECT_RATIO_LABEL = "16:9";
export const RECOMMENDED_IMAGE_MIN_SIZE_LABEL = "1280x720 px";
export const RECOMMENDED_IMAGE_IDEAL_SIZE_LABEL = "1920x1080 px";
