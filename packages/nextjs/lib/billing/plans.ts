...
export const EARLY_ACCESS_PRICE_VERSION = "early_access_usd_99_2026_07" as const;

export type TokenlessBillingPlanKey = "free" | "early_access";
export type TokenlessBillingPriceVersion = typeof DEFAULT_FREE_PRICE_VERSION | typeof EARLY_ACCESS_PRICE_VERSION;
...
export function getPlanByPriceVersion(priceVersion: string): TokenlessBillingPlan | null {
  return priceVersion === DEFAULT_FREE_PRICE_VERSION || priceVersion === EARLY_ACCESS_PRICE_VERSION
    ? TOKENLESS_PRICE_VERSIONS[priceVersion]
    : null;
}
