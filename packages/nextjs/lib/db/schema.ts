...
export const contentFeedback = pgTable(
  "content_feedback",
  {
    ...
    onchainRevealStatus: text("onchain_reveal_status").notNull().default("pending"),
    onchainRevealAttempts: integer("onchain_reveal_attempts").notNull().default(0),
    onchainRevealNextAttemptAt: timestamp("onchain_reveal_next_attempt_at", { mode: "date", withTimezone: true }),
    onchainRevealLeaseUntil: timestamp("onchain_reveal_lease_until", { mode: "date", withTimezone: true }),
    onchainRevealTxHash: text("onchain_reveal_tx_hash"),
    onchainRevealError: text("onchain_reveal_error"),
    onchainRevealedAt: timestamp("onchain_revealed_at", { mode: "date", withTimezone: true }),
    createdAt: timestamp("created_at", { mode: "date", withTimezone: true }).notNull(),
  ...
  table => ({
    ...
    onchainRevealQueueIdx: index("content_feedback_onchain_reveal_queue_idx").on(
      table.onchainRevealStatus,
      table.onchainRevealNextAttemptAt,
      table.onchainRevealLeaseUntil,
      table.createdAt,
    ),
