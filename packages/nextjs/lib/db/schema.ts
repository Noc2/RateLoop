...
export const agentAskHandoffIntents = pgTable(
  "agent_ask_handoff_intents",
  {
    ...
    transactionPlan: text("transaction_plan"),
    transactionHashes: text("transaction_hashes"),
    feedbackBonusTransactionHashes: text("feedback_bonus_transaction_hashes"),
    feedbackBonusStatus: text("feedback_bonus_status"),
    feedbackBonusError: text("feedback_bonus_error"),
    error: text("error"),
    expiresAt: timestamp("expires_at", { mode: "date", withTimezone: true }).notNull(),
    createdAt: timestamp("created_at", { mode: "date", withTimezone: true }).notNull(),
    updatedAt: timestamp("updated_at", { mode: "date", withTimezone: true }).notNull(),
