        ...
        rows: [
          {
            ...
            assignment_expires_at: new Date(NOW.getTime() + 60_000),
            state: "selected",
            ...
            voucher_status: "open",
            voucher_deadline: new Date(NOW.getTime() + 60_000),
            reachability_state: "audience_ready",
            opportunity_status: "review_requested",
            opportunity_lifecycle_state: "pending",
            question_visibility: "public",
            question_data_classification: "synthetic",
