...
const agentPaymentOutputSchema = {
  ...
  properties: {
    ...
    feedbackBonusAmount: atomicAmountSchema,
    feedbackBonusAsset: { type: ["string", "null"] },
    spender: { type: "string" },
    tokenAddress: { type: "string" },
    totalAmount: atomicAmountSchema,
  },
  type: "object",
} satisfies JsonSchema;
...
export const agentQuoteOutputSchema = {
  ...
  properties: {
    ...
    maxPaymentAmountHint: atomicAmountSchema,
    operationKey: { type: "string" },
    payment: agentPaymentOutputSchema,
    dryRun: { type: "boolean" },
    executionMode: { enum: ["dry_run"], type: "string" },
    paymentMode: { enum: ["wallet_calls", "eip3009_usdc_authorization", "x402_authorization"], type: "string" },
