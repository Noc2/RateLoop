...
const agentBountyInputSchema = {
  ...
  properties: {
    ...
    bountyEligibility: {
      default: 0,
      description:
        "Bounty payout scope bitmask: 0 everyone, 2 Selfie Check, 4 Passport, 8 Proof of Human; add bits to allow any selected credential, and add 128 to require a recent recheck. Everyone can still answer.",
      enum: [
        0,
        2,
        4,
