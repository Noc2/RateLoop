...
| `invalid_media` | The image or video inputs do not meet the accepted shape. Image URLs must be approved RateLoop-hosted uploads. | Fix the media URLs and re-quote. |
