...
import { GradientActionButtonV2, MicroLabel, surfaceCardStyle } from "../../v2ui";
...
/** Beat 3 (v2) — the real agent-ask handoff page: kicker, summary grid, Submit. */
export const HandoffV2 = () => {
