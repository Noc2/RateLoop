...
import { GradientActionButtonV2, MicroLabel, VoteButtonV2, surfaceCardStyle, votingCardOverlay } from "../../v2ui";
...
/** Beat 4 (v2) — the real voting card (orb + Up/Down), then the stake sheet. */
export const RatersV2 = () => {
  const frame = useCurrentFrame();
          ...
          >
            ...
            >
              ...
              <div style={{ marginTop: 18, display: "flex", gap: 24 }}>
                <VoteButtonV2 up pressed={upPick} scale={pickScale} />
                <VoteButtonV2 up={false} />
              </div>
            </div>
