...
const BEATS: Beat[] = [
  ...
  { start: starts[1], duration: ASK, vo: "audio/vo-02-ask.m4a", voDurationInFrames: 177, Scene: AgentAsk },
  { start: starts[2], duration: HANDOFF, vo: "audio/vo-03-handoff.m4a", voDurationInFrames: 203, Scene: Handoff },
