...
If you discover a security vulnerability in the RateLoop protocol (smart contracts, API routes, or infrastructure), please report it responsibly.
...
- Vendored upstream code under `packages/foundry/lib/*` unless the issue is caused by a RateLoop-specific modification or integration bug
